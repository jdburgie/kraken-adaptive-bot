...
STOP_PCT      = float(os.getenv("STOP_PCT",      0.025))  # 2.5% trailing stop
TAKE_PCT      = float(os.getenv("TAKE_PCT",      0.09))   # 9% take profit
...
RSI_SELL      = float(os.getenv("RSI_SELL", 65.0))  # exit when RSI above this
